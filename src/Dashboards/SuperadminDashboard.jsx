    ...
    const fetchEventData = async () => {
      try {
        ...
        const mappedData = [
          ...
          {
            eventType: 'Ongoing Events',
            number: data.ongoing_events,
            icon: <MdPending className="text-purple-500" />,
          },
          {
    ...
    <div className="flex w-full min-h-screen bg-[#f7fafc] overflow-x-hidden">
      ...
      <main className="w-full">
        ...
        <div className="p-4 lg:p-8 w-full overflow-hidden">
          {/* title */}
          <h1 className="text-[1.5rem] sm:text-[2rem] font-semibold mb-2 md:mb-5 ">
            Dashboard
          </h1>
