  ...
  const fetchAssignedEvents = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        '/employees-upcoming-event-details/'
      );
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div
        ...
        } transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex flex-col lg:w-64 p-4 pt-20`}
      >
        <button
                  ...
                  <table className="w-full text-sm text-left text-gray-500">
                    <thead className="text-xs text-white uppercase bg-gray-800">
                      <tr>
                        ...
                        <th className="px-6 py-3 font-medium whitespace-nowrap w-24">
                          Status
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      {assignedEvents.map((event, index) => (
                        <tr key={index} className="bg-white hover:bg-gray-50">
                          ...
                          <td className="px-6 py-6 whitespace-nowrap w-24">
